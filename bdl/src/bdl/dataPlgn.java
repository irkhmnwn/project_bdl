 ...
 * @author Irkhamnawan
 */
public class dataPlgn extends javax.swing.JDialog {

    /**
     * Creates new form dataPlgn
     */
    public dataPlgn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tampilPlgn();
    }

    public void tampilPlgn() {
...
//        
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pelanggan", "Nama Pelanggan", "Alamat ", "No Telp"
            }
        ));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 380, 330));
    ...
    if (p != null) {
        ...
        String telpPelanggan = p.getTelpPelanggan();
                ...
                sewa.idpelanggan.setText(idPelanggan);
                sewa.namapelanggan.setText(namaPelanggan);// Set the retrieved data to the JTextField
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataPlgn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dataPlgn dialog = new dataPlgn(new javax.swing.JFrame(), true);
